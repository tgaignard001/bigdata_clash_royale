...
public class DeckSummaryWritable implements Serializable, Cloneable, Writable {
    ...
    public void updateDeckSummary(DeckSummaryWritable deckSummaryWritable) {
        this.victories += deckSummaryWritable.victories;
        this.uses += deckSummaryWritable.uses;
        this.highestClanLevel = Math.max(deckSummaryWritable.highestClanLevel, this.highestClanLevel);
        this.uniquePlayers = Math.max(deckSummaryWritable.uniquePlayers, this.uniquePlayers);
        this.sumDiffForce += deckSummaryWritable.sumDiffForce;
        this.nbDiffForce += deckSummaryWritable.nbDiffForce;
        this.year = (this.year == 0) ? deckSummaryWritable.year : this.year;
        this.month = (this.month == 0) ? deckSummaryWritable.month : this.month;
    }
